...
exports.getRecentActivity = exports.getDashboardChartData = exports.getDashboardStats = void 0;
...
const getDashboardStats = async (req, res) => {
    try {
        ...
        if (isSuperAdmin) {
            targetOrgId = req.query.organization_id || null;
        }
...
const getRecentActivity = async (req, res) => {
    try {
        ...
        const newMembers = await (0, database_1.query)(membersQuery, membersParams);
        ...
        const recentContribs = await (0, database_1.query)(contribQuery, contribParams);
        ...
        const recentClaims = await (0, database_1.query)(claimsQuery, claimsParams);
