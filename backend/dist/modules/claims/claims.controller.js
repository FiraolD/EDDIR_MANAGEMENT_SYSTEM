...
exports.exportClaims = exports.getClaimStats = exports.deleteClaim = exports.updateClaimStatus = exports.payClaim = exports.advanceClaim = exports.createClaim = exports.getClaimById = exports.getClaims = void 0;
...
const getClaimById = async (req, res) => {
    try {
        const { id } = req.params;
        const result = await (0, database_1.query)(`SELECT c.*, m.full_name AS member_name, m.member_number
             FROM claims c
             JOIN members m ON m.id = c.member_id
             WHERE c.id = $1`, [id]);
...
const createClaim = async (req, res) => {
    try {
        ...
        const result = await (0, database_1.query)(`INSERT INTO claims (
            ...
            RETURNING *`, [member_id, organizationId, claimNumber, deceased_name, relationship, date_of_death, amount, notes, documentPath ? [documentPath] : []]);
        // Log workflow
    ...
    try {
        ...
        if (nextStatus === 'paid') {
            ...
            await (0, database_1.query)(`INSERT INTO transactions (transaction_number, type, category, amount, member_id, claim_id, description, organization_id)
                 VALUES ($1, 'debit', 'claim_payout', $2, $3, $4, 'Death benefit payout', $5)`, [transactionNumber, current.rows[0].amount, current.rows[0].member_id, id, current.rows[0].organization_id]);
        }
        res.json({
            success: true,
