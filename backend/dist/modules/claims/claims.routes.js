...
router.get('/', (0, auth_1.authorize)('super_admin', 'org_admin', 'edir_leader', 'finance'), claims_controller_1.getClaims);
// Get claim statistics
router.get('/stats', (0, auth_1.authorize)('super_admin', 'org_admin', 'finance'), claims_controller_1.getClaimStats);
...
router.get('/:id', (0, auth_1.authorize)('super_admin', 'org_admin', 'edir_leader', 'finance'), claims_controller_1.getClaimById);
...
router.put('/:id/advance', (0, auth_1.authorize)('super_admin', 'org_admin', 'edir_leader', 'finance'), claims_controller_1.advanceClaim);
