...
export const contributionsAPI = {
  getAll: (params?: { page?: number; limit?: number; search?: string; status?: string; memberId?: string }) =>
  ...
  reconcile: (data: any) => api.post('/contributions/reconcile', data),
};

// ==================== CLAIMS API ====================
export const claimsAPI = {
  getAll: (params?: { page?: number; limit?: number; status?: string; memberId?: string }) =>
...
export const dashboardAPI = {
  ...
  getChartData: (period?: string) => api.get('/dashboard/chart', { params: { period } }),
  
  getRecentActivity: (limit?: number) => api.get('/dashboard/recent', { params: { limit } }),
};
